        ...
        <div class="modal-content">
            ...
            <form class="form" action="javascript:void(0)" id="kt_modal_update_unit_form"
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" id="name-input-update" placeholder="{{__('unit.type_unit_name')}}" name="name"
                                value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                ...
                <div class="modal-footer flex-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="submit" id="kt_modal_update_unit_submit" class="btn btn-primary">
