...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <!--end::Svg Icon-->
                <input type="text" data-kt-customer-table-filter="search" id="search-field" class="form-control form-control-sm form-control-solid w-250px ps-15" placeholder="{{trans('customer.search_customer')}}" />
            </div>
            <!--end::Search-->
        </div>
        <!--begin::Card title-->
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                ...
                <!--end::Svg Icon-->{{__('common.filter')}}</button>
                <!--begin::Menu 1-->
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
                    <!--begin::Header-->
                    <div class="px-7 py-5">
                        <div class="fs-4 text-dark fw-bolder">{{__('common.filter_option')}}</div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Separator-->
                    ...
                    <form>
                        ...
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                <!--begin::Label-->
                                <label class="form-label fs-5 fw-bold mb-3">{{__('common.status')}}:</label>
                                <!--end::Label-->
                                <!--begin::Options-->
                                <div class="d-flex flex-column flex-wrap fw-bold" data-kt-customer-table-filter="payment_type">
                                    ...
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-3 me-5">
                                        ...
                                        <span class="form-check-label text-gray-600">{{__('common.all')}}</span>
                                    </label>
                                    <!--end::Option-->
                                    <!--begin::Option-->
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-3 me-5">
                                        <input class="form-check-input" type="radio" name="status" value="1" />
                                        <span class="form-check-label text-gray-600">{{__('common.active')}}</span>
                                    </label>
                                    <!--end::Option-->
                                    <!--begin::Option-->
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-3 me-5">
    ...
    <!--end::Card header-->
    <!--begin::Card body-->
    <div class="card-body pt-0" id="kt_customers_table">
        <!--begin::Table-->
...
@section('pageJs')
    ...
    <script>
        $(document).ready(function () {
            var instance = new CustomerClass();
            instance.run();
        })
    </script>
@endsection