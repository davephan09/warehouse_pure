...
@section('breadcrumb')
{{ Breadcrumbs::render('category_product_detail', $category) }}
@endsection
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-10 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="category_name" class="form-control form-control-sm mb-2" placeholder="{{__('category.type_name')}}" value="{{$category->name}}" />
                    <!--end::Input-->
                    <!--begin::Description-->
