    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder" id="modal-title">Assign Role to User</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-lg-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_role_form" class="form" action="javascript:;">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_role_header" data-kt-scroll-wrappers="#kt_modal_add_role_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <select name="user" class="form-select form-select-solid" id="user-name"></select>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3 btn-sm" data-bs-dismiss="modal" data-kt-roles-modal-action="cancel">Discard</button>
