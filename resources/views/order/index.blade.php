...
<div class="card card-flush">
    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1 me-4">
                ...
                <!--end::Svg Icon-->
                <input type="text" data-kt-ecommerce-order-filter="search" id="search-field" class="form-control form-control-sm form-control-solid w-250px ps-14" placeholder="{{__('order.search_bill')}}" />
            </div>
            <!--end::Search-->
            <div class="">
        ...
        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            ...
            @can('order.create')
            <!--begin::Add product-->
            <a href="{{ route('order.create') }}" class="btn btn-sm btn-primary">{{ __('common.add_order') }}</a>
            <!--end::Add product-->
            @endcan
        </div>
        <!--end::Card toolbar-->
    ...
    <!--end::Card header-->
    <!--begin::Card body-->
    <div class="card-body pt-0" id="order-table">
        <!--begin::Table-->
...
@section('pageJs')
    <script src="{{ url('assets/js/pages/order.js') }}"></script>
    <script>
