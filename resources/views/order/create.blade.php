            ...
            <div class="card-body pt-0">
                <div class="d-flex flex-column gap-10">
                    ...
                    <div class="fv-row">
                        ...
                        <div class="fw-bolder fs-3" id="order-id">#{{$orderId}}</div>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                                                ...
                                                <tbody class="body-item">
                                                    <tr>
                                                        ...
                                                        <td class=" pb-8 input-group input-group-sm input-group-solid">
                                                            <input type="text" class="form-control form-control-sm form-control-solid auto-cal text-end price-input" data-plugin="inputmask-numeric" name="price[]" disabled placeholder="0" value="" data-kt-element="price" />
                                                    ...
                                                    <tr index="0">
                                                        <td class="py-0 text-end fw-bold tax-desc" style="display: none"><span class="pe-8">{{ __('tax.taxes') }}</span></td>
                    ...
                    <div class="d-flex flex-column flex-md-row gap-5">
                        ...
                        <div class="flex-row-fluid  col-6">
                            ...
                            <div class="d-flex input-group input-group-sm input-group-solid">
                                <input class="form-control form-control-sm" id="amount-paid" data-plugin="inputmask-numeric" type="text" name="billing_order_address_2" placeholder="{{__('order.type_price')}}">
                                <span class="input-group-text">đ</span>
                            </div>
                        </div>
                    </div>
