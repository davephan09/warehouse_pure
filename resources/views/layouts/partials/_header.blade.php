        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    @php
                        $newNotifications = \App\Classes\Notifications::listNewNotifications();
                        $countNew = $newNotifications ? $newNotifications->total() : 0;
                    @endphp
                    <!--begin::Menu- wrapper-->
                    <div class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary position-relative w-30px h-30px w-md-40px h-md-40px"
                        ...
                        @if ($countNew)
                            <span class="position-absolute top-0 start-100 translate-middle badge badge-circle badge-danger badge-sm min-w-unset" style="width: 1.1rem !important; height: 1.1rem !important; font-size: 0.65rem;">{{ $countNew }}</span>
                        @endif
                        <!--end::Svg Icon-->
                    </div>
                    <!--begin::Menu-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="hover"
                            ...
                            <a href="#" class="menu-link px-5">
                                <span class="menu-title position-relative">{{ __('common.language') }}
                                    @php
                                        ...
                                        switch ($curLocale) {
                                            case 'en' :
                                                $flagLocale = 'assets/media/flags/united-states.svg';
                                                break;
                                            case 'vi' :
                                                $flagLocale = 'assets/media/flags/vietnam.svg';
                                                break;
                                            default :
                                                $flagLocale = 'assets/media/flags/united-states.svg';
                                        }
                                    @endphp
                                    <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ __('common.' . $curLocale) }}
                                        <img class="w-15px h-15px rounded-1 ms-2" src="{{ $flagLocale }}" alt="" />
                                    </span>
                                </span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="javascript:;" class="menu-link d-flex px-5 switch-lang active" data-lang="en">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="javascript:;" class="menu-link d-flex px-5 switch-lang" data-lang="vi">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src="assets/media/flags/vietnam.svg" alt="" />
                                        </span>{{ __('common.vi') }}
                                    </a>
                                </div>
                                <!--end::Menu item-->
