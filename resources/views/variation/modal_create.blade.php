<div class="modal fade" id="kt_modal_add_variation" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <form id="kt_modal_add_variation_form" class="form" action="javascript:void(0)">
                <div class="modal-header">
                    <h2 class="fw-bolder">{{ __('variation.add_new_variation') }}</h2>
                ...
                <div class="modal-body scroll-y mx-lg-5 my-7">
                    ...
                    <div class="fv-row mb-12">
                        ...
                        <select class="form-select form-select-sm form-select-solid" name="options" id="var-options" data-control="select2" data-allow-clear="true" multiple
