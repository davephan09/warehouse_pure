        ...
        <div class="modal-content">
            ...
            <form class="form" action="javascript:void(0)" id="kt_modal_update_tax_form"
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-sm form-control-solid" id="name-input-update" placeholder="{{__('tax.type_tax_name')}}" name="name"
                                value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-sm form-control-solid" id="description-update" placeholder="{{__('tax.type_tax_description')}}" name="description"
                                value="" />
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7">
                ...
                <div class="modal-footer flex-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="submit" id="kt_modal_update_tax_submit" class="btn btn-sm btn-primary">
