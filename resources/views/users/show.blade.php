...
<div class="d-flex flex-column flex-lg-row">
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-stack fs-4 py-3">
                    <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_user_view_details" role="button" aria-expanded="false" aria-controls="kt_user_view_details">{{ __('common.details') }}
    ...
    <div class="flex-lg-row-fluid ms-lg-15">
        ...
        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
            <!--begin:::Tab item-->
            <li class="nav-item">
                <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_user_view_overview_tab">{{ __('user.overview') }}</a>
            </li>
            <!--end:::Tab item-->
            <!--begin:::Tab item-->
            <li class="nav-item">
                <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_view_overview_security">{{ __('user.security') }}</a>
            </li>
            <!--end:::Tab item-->
            <!--begin:::Tab item-->
            <li class="nav-item">
                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_user_view_overview_events_and_logs_tab">{{ __('user.permissions') }}</a>
            </li>
            <!--end:::Tab item-->
        </ul>
        <!--end:::Tabs-->
            ...
            <div class="tab-pane fade show active" id="kt_user_view_overview_tab" role="tabpanel">
                ...
                <div class="card card-flush mb-6 mb-xl-9">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-title flex-column">
                            <h2 class="mb-1">{{ __('user.user_order') }}</h2>
                            <div class="fs-6 fw-bold text-muted" id="total-order"></div>
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
                    ...
                    <!--end::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body p-9 pt-4 loading_tab" id="list-order">
                        <!--begin::Tab Content-->
                ...
                <div class="card card-flush mb-6 mb-xl-9">
                    ...
                    <div class="card-header mt-6">
                        <!--begin::Card title-->
                        <div class="card-title flex-column">
                            <h2 class="mb-1">{{ __('user.purchasing_user') }}</h2>
                            <div class="fs-6 fw-bold text-muted" id="total-purchasing"></div>
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
                        <div class="card-toolbar">
                    ...
                    <!--end::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body d-flex flex-column p-9 pt-4 loading_tab" id="purchasing-table">
            ...
            <div class="tab-pane fade" id="kt_user_view_overview_events_and_logs_tab" role="tabpanel">
                ...
                <div class="card pt-4 mb-6 mb-xl-9">
                    ...
                    <div class="card-header border-0">
                        <!--begin::Card title-->
                        <div class="card-title">
                            <h2>{{ __('role_permission.permission_list') }}</h2>
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
                        <div class="card-toolbar">
                    ...
                    <div class="card-body pt-0 pb-5">
                        ...
                        <div class="table-responsive">
                            <!--begin::Table-->
                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_user_permissions">
...
<div class="modal fade" id="kt_modal_assign_permission" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">{{__('user.assign_permissions')}}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-lg-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_assign_permission_form" class="form" action="javascript:void(0)">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll"
                        ...
                        <div class="fv-row">
                            <!--begin::Label-->
                            <label class="fs-5 fw-bolder form-label mb-2">{{ __('role_permission.permission_list') }}</label>
                            <!--end::Label-->
                            <!--begin::Table wrapper-->
                            <div class="table-responsive">
                                <!--begin::Table-->
                                <table class="table align-middle table-row-dashed fs-6 gy-5">
                                    ...
                                    <tbody class="text-gray-600 fw-bold">
                                        <!--begin::Table row-->
                                        <tr>
                                            <td class="text-gray-800">{{ __('user.admin_access') }}
                                            ...
                                            <td>
                                                ...
                                                <label class="form-check form-check-custom form-check-solid me-9">
                                                    ...
                                                    <span class="form-check-label" for="kt_roles_select_all">{{ __('common.select_all') }}</span>
                                                </label>
                                                <!--end::Checkbox-->
                                            </td>
                                        </tr>
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary" data-kt-roles-modal-action="submit" id="submit-btn">
...
@section('pageJs')
    <script src="{{ url('assets/js/pages/user.detail.js') }}"></script>
    <script>
