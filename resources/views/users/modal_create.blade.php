            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_modal_add_user_form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-bold fs-6 mb-2">{{trans('common.full_name')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="user_name" required class="form-control form-control-solid mb-3 mb-lg-0"
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-bold fs-6 mb-2">{{trans('common.email')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="email" name="user_email" required class="form-control form-control-solid mb-3 mb-lg-0"
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-bold fs-6 mb-2">{{trans('common.phone')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="tel" name="user_phone" required class="form-control form-control-solid mb-3 mb-lg-0"
